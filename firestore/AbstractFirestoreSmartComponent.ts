...
export abstract class AbstractFirestoreSmartComponent<
  T extends AbstractFirestoreDocument
> {
  public document: T | undefined;
  public documentSubscription$: Subscription | undefined;

  protected constructor(
    private documentRepository: AbstractFirestoreDocumentRepository<T>
  ) {}
